package jp.co.oneplanet.androidxr.sample.prestartandroidxr
...
import jp.co.oneplanet.androidxr.sample.prestartandroidxr.ui.theme.OnePlanetPreStartAndroidXRTheme
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            OnePlanetPreStartAndroidXRTheme {
